 ...
 ******************************************************************************/
package org.openiot.ui.request.definition.web.model.nodes.impl.generators;
 ...
 */
@GraphNodeClass(label = "TimestampGenerator", type = "GENERATOR", scanProperties = true)
@Endpoints({
    @Endpoint(type = EndpointType.Output, anchorType = AnchorType.Right, scope = "Date", label = "timestamp", required = true)
})
public class TimestampGenerator extends DefaultGraphNode implements Serializable {
