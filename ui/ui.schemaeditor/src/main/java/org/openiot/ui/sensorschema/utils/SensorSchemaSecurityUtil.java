...
public class SensorSchemaSecurityUtil {
	
	private static Logger logger = LoggerFactory.getLogger(SensorSchemaSecurityUtil.class);
	...
	private static AccessControlUtil acUtil = AccessControlUtil.getInstance();
