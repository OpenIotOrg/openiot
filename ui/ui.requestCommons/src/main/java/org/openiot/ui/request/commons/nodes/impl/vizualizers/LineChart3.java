 ...
 ******************************************************************************/
package org.openiot.ui.request.commons.nodes.impl.vizualizers;
 ...
 */
@GraphNodeClass(label = "LineChart3", type = "VISUALIZER", scanProperties = true)
@Endpoints({
    @Endpoint(type = EndpointType.Input, anchorType = AnchorType.Left, scope = "Number", label = "x", required = true),
    @Endpoint(type = EndpointType.Input, anchorType = AnchorType.Left, scope = "Number", label = "y1", required = true),
    @Endpoint(type = EndpointType.Input, anchorType = AnchorType.Left, scope = "Number", label = "y2", required = true),
    @Endpoint(type = EndpointType.Input, anchorType = AnchorType.Left, scope = "Number", label = "y3", required = true)
})
@NodeProperties({
    ...
    @NodeProperty(type = PropertyType.Writable, javaType = java.lang.String.class, name = "SERIES2_LABEL", required = true),
    @NodeProperty(type = PropertyType.Writable, javaType = java.lang.String.class, name = "SERIES3_LABEL", required = true)})
public class LineChart3 extends DefaultGraphNode implements Serializable, Observer, GraphNodeEventListener {
    ...
    public LineChart3() {
        ...
        setProperty("SERIES2_LABEL", "series2");
        setProperty("SERIES3_LABEL", "series3");
