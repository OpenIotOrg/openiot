 ...
 */
@GraphNodeClass(label = "LineChart2", type = "VISUALIZER", scanProperties = true)
@Endpoints({
...
public class LineChart2 extends DefaultGraphNode implements Serializable, Observer, GraphNodeEventListener {
