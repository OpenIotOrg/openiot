...
What is it?
-----------
The IDE tool intends to incorporate all the components that will be developed for OpenIOT. Initially it includes links to the "Request Definition" component
as well as the monitoring tools. In order to maximize working space the top and west panes may be minimized.
