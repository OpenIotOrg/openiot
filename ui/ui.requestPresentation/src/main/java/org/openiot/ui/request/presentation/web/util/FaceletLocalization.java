...
package org.openiot.ui.request.presentation.web.util;
...
public class FaceletLocalization {
    ...
    public static ResourceBundle getLocalizedResourceBundle() {
        ...
        if (context != null && context.getViewRoot() != null && context.getViewRoot().getLocale() != null) {
            return ResourceBundle.getBundle("org.openiot.ui.request.presentation.web.i18n.messages", FacesContext.getCurrentInstance().getViewRoot().getLocale());
        }
        return null;
    }
