...
// Generated on: 2013.06.27 at 08:32:16 μμ EEST 
//
...
public class ObjectFactory {
    ...
    private final static QName _OAMO_QNAME = new QName("urn:openiot:osdspec:xsd:1", "OAMO");
    private final static QName _OSMO_QNAME = new QName("urn:openiot:osdspec:xsd:1", "OSMO");
    private final static QName _GraphMeta_QNAME = new QName("urn:openiot:osdspec:xsd:1", "graphMeta");
    private final static QName _OSDSpec_QNAME = new QName("urn:openiot:osdspec:xsd:1", "OSDSpec");
    private final static QName _Description_QNAME = new QName("urn:openiot:osdspec:xsd:1", "description");
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link OAMO }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "urn:openiot:osdspec:xsd:1", name = "OAMO")
    public JAXBElement<OAMO> createOAMO(OAMO value) {
        return new JAXBElement<OAMO>(_OAMO_QNAME, OAMO.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link OSMO }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "urn:openiot:osdspec:xsd:1", name = "OSMO")
    public JAXBElement<OSMO> createOSMO(OSMO value) {
        return new JAXBElement<OSMO>(_OSMO_QNAME, OSMO.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:openiot:osdspec:xsd:1", name = "graphMeta")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link OSDSpec }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "urn:openiot:osdspec:xsd:1", name = "OSDSpec")
    public JAXBElement<OSDSpec> createOSDSpec(OSDSpec value) {
        return new JAXBElement<OSDSpec>(_OSDSpec_QNAME, OSDSpec.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:openiot:osdspec:xsd:1", name = "description")
