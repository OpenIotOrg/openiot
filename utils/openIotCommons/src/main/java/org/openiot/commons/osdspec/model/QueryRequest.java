 ...
 *         &lt;sequence>
 *           &lt;element ref="{}maxDynamicAttr" maxOccurs="unbounded"/>
 *         &lt;/sequence>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
...
public class QueryRequest {
    ...
    @XmlElement(required = true)
    protected List<MaxDynamicAttr> maxDynamicAttr;
    ...
    /**
     * Gets the value of the maxDynamicAttr property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the maxDynamicAttr property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMaxDynamicAttr().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<MaxDynamicAttr> getMaxDynamicAttr() {
        if (maxDynamicAttr == null) {
            maxDynamicAttr = new ArrayList<MaxDynamicAttr>();
        }
        return this.maxDynamicAttr;
    }
