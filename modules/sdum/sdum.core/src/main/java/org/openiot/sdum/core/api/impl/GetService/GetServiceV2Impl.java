...
//				}// while
		...
		public static RequestPresentation parseWidgetPreListByService(TupleQueryResult qres) 
		{
			RequestPresentation reqPresentation = new RequestPresentation();
...
//				}// while
	...
	private void findOSMO() 
	{
		...
		Queries.RequestPresentation reqPre = Queries.parseWidgetPreListByService(qres);
