...
public class WidgetPresentation {
	...
	// private ArrayList<WidgetAvailable> widgetList = new
	// ArrayList<WidgetAvailable>();
	...
	private void initOnt_WidgetPres() {
		...
		ontPwidgetPresDescription = myOnt
				.createProperty("http://openiot.eu/ontology/ns/widgetPresDescription");
	...
	public void createPdescription() {
		if (description != null)
			widgetPresClassIdv.setPropertyValue(ontPwidgetPresDescription, ontInstance.getBase()
