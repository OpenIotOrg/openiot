...
public class User {
	...
	public static class Queries {
		...
		// +"WHERE "
		// +"{"
		// +"?userID <http://openiot.eu/ontology/ns/userName> ?name FILTER regex(?name, \""
		// +usrName+ "\" )  . "
		// +"}");
		//
		// update.append(str);
		...
		// +"WHERE "
		// +"{"
		// +"?userID <http://openiot.eu/ontology/ns/userDescription> ?desc FILTER regex(?desc, \""
		// +desc+ "\" )  . "
		// +"}");
		//
		// update.append(str);
		...
		// public static String selectUserByNameAndDescription(String
		// usrName,String desc,String email)
		// {
		// StringBuilder update = new StringBuilder();
		// update.append(getNamespaceDeclarations());
		//
		...
		// +"?userID <http://openiot.eu/ontology/ns/userDescription> ?desc FILTER regex(?desc, \""
		// +desc+ "\" )  . "
		// +"?userID <http://openiot.eu/ontology/ns/userMail> ?email FILTER regex(?email, \""
		// +email+ "\" )  . "
		// +"}");
		//
		// update.append(str);
		// return update.toString();
		// }
		// public static String selectUserByService(ArrayList<Service>
		// serviceList)
		// {
		// StringBuilder update = new StringBuilder();
		// update.append(getNamespaceDeclarations());
	...
	private void initOnt_USer() {
		...
		// ontPaccess =
		// myOnt.createProperty("http://openiot.eu/ontology/ns/access");
	...
	public void createPdescription() {
		if (description != null)
			userClassIdv.setPropertyValue(ontPdescription,
