...
{	
	...
	{		
		...
		public static String getMeasumerementAndUnitOfSensorTypeInArea(double longitude, double latitude, float radius,String sensorType)
		{
			StringBuilder update = new StringBuilder();	        
		...
		public static String getMeasumerementDataTypeOfSensorTypeInArea(double longitude, double latitude, float radius,String sensorType,String measurement,String unit)
		{
			StringBuilder update = new StringBuilder();	        
	...
	private void discoversensors() 
	{
		...
		for (int i=0; i<sensorTypesList.size(); i++) 
		{
			...
			qres = sparqlCl.sparqlToQResult(Queries.getMeasumerementAndUnitOfSensorTypeInArea(longitude, latitude, radius,sensorTypesList.get(i).getLabel()));
			...
			for (int j=0; j<sensorTypeMetaDataList.size(); j++) 
			{
				...
				qres = sparqlCl.sparqlToQResult(Queries.getMeasumerementDataTypeOfSensorTypeInArea(longitude, latitude, radius,sensorTypesList.get(i).getLabel(),mc.getType(),unit.getName()));
