...
public class WidgetAttributes {
	...
	public static class Queries {
		...
		public static String selectWidgetAttrByName(String graph,String widgetAttrName) {
			...
			String str = ("SELECT ?widgetAttrID ?widgetAttrName ?widgetAttrDesc ?widgetAttrOf from <"
					+ graph
					+ "> "
					+ "WHERE "
					+ "{"
					+ "?widgetAttrID <http://openiot.eu/ontology/ns/widgetAttrOf> ?widgetAttrOf . "
					+ "?widgetAttrID <http://openiot.eu/ontology/ns/widgeAttrDescription> ?widgetAttrDesc . "
					+ "?widgetAttrID <http://openiot.eu/ontology/ns/widgetAttrName> ?name FILTER regex(?name, \""
					+ widgetAttrName + "\" )  . "
					+ "?widgetAttrID rdf:type <http://openiot.eu/ontology/ns/WidgetAttr> ." + "}");
		...
		public static String selectWidgetAttrByDescription(String graph,String desc) {
			...
			String str = ("SELECT ?widgetAttrID ?widgetAttrName ?widgetAttrDesc ?widgetAttrOf from <"
					...
					+ "?widgetAttrID <http://openiot.eu/ontology/ns/widgetAttrOf> ?widgetAttrOf . "
					+ "?widgetAttrID <http://openiot.eu/ontology/ns/widgetAttrName> ?widgetAttrName . "
					+ "?widgetAttrID <http://openiot.eu/ontology/ns/widgeAttrDescription> ?desc FILTER regex(?desc, \""
					+ desc + "\" )  . "
					+ "?widgetAttrID rdf:type <http://openiot.eu/ontology/ns/WidgetAttr> ." + "}");
	...
	private void initOnt_WidgetAttr() {
		...
		ontPwidgetAttrDescription = myOnt
				.createProperty("http://openiot.eu/ontology/ns/widgeAttrDescription");
	...
	// {
	// if(description!=null)
	// widgetAttrClassIdv.setPropertyValue(ontPwidgetAttrDescription,
	// ontInstance.getBase().createTypedLiteral(description));
	// if(name!=null)
	// widgetAttrClassIdv.setPropertyValue(ontPwidgetAttrName,
	// ontInstance.getBase().createTypedLiteral(name));
	//
	// widgetAttrClassIdv.addProperty(ontPwidgetAttrOf,
	// widgetPres.getClassIndividual());
	// }

	public void createPdesc() throws NullPointerException {
		if (description != null)
			widgetAttrClassIdv.setPropertyValue(ontPwidgetAttrDescription, ontInstance.getBase()
