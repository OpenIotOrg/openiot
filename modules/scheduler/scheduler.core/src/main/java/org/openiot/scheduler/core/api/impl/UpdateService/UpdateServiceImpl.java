package org.openiot.scheduler.core.api.impl.UpdateService;
...
public class UpdateServiceImpl {
	...
	final static Logger logger = LoggerFactory.getLogger(UpdateServiceImpl.class);
	...
	// constructor //
	public UpdateServiceImpl(OSDSpec osdSpec) {
