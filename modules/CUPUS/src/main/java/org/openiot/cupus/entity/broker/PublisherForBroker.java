...
/**
 * This class is a representation of a publisher connected with a broker
 * on the broker it is connected with.
 * It is used for communication with the publisher and identification
 * of the publisher on the broker (via UUID).
 * 
 * @author Eugen
 * 
 */
