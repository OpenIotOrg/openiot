 ...
 * @author Aleksandar
 */
public class ActSubNode {

    public ActiveSubscription data;
    public List<ActSubNode> children;

    public ActSubNode(ActiveSubscription sub) {
        data = sub;
        children = new ArrayList<ActSubNode>();
    }
     ...
     */
    public List<ActSubNode> getChildren() {
        return this.children;
    }

    public List<ActSubNode> getFutureParents(ActiveSubscription subscription) {
     ...
     */
    public void setChildren(List<ActSubNode> children) {
     ...
     */
    public void addChild(ActSubNode child) {
        children.add(child);
    }
     ...
     */
    public void insertChildAt(int index, ActSubNode child) throws IndexOutOfBoundsException {
